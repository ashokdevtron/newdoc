...
| **Upgrade Devtron to latest version** | You can upgrade Devtron in one of the following ways:<ul><li>[Upgrade Devtron using Helm](../../setup/upgrade/README.md#upgrade-devtron-using-helm)</li><li>[Upgrade Devtron from UI](../../setup/upgrade/upgrade-devtron-ui.md)</li></ul> |
